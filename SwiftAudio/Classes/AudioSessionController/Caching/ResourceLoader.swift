...
//  SwiftAudio
//
//  Created by Babak Afsheh on 2/10/21.
//

import Foundation
import AVFoundation

class ResourceLoader: NSObject, AVAssetResourceLoaderDelegate, URLSessionDataDelegate, URLSessionTaskDelegate {
    ...
    lazy var streamingAssetURL: URL = {
        ...
        components.scheme = (components.scheme ?? "") + ResourceLoader.SchemeSuffix
